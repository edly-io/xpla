...
export type Activity = { id: string; page_id: string; activity_type: string; position: number; client_path: string; state: unknown; permission: string; scope: { user_id: string; course_id: string; activity_id: string } };
