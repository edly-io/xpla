"""
FastAPI application for the PXC server.
"""
...
app = FastAPI(
    title="PXC Server",
    description="LMS simulation for PXC development",
    version="0.3.0",
)
...
def get_simulation_params(cookies: dict[str, str]) -> tuple[str, Permission]:
    ...
    permission_str = cookies.get("pxc_permission")
...
@app.get("/a/{activity_type}/ui.js")
async def activity_ui(request: Request, activity_type: str) -> FileResponse:
