...
#   timestamp: 2026-02-26T16:32:13+00:00
...
class ValueDefinition(BaseModel):
    ...
    scope: Annotated[
        Scope,
        Field(
            description="Scope of the value. Scopes without 'user' are shared across users. 'unit' scopes are per-activity-instance, 'course' scopes are per-course, 'platform' scopes are global."
        ),
    ]
    default: Annotated[
